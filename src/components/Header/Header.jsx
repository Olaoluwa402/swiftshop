  ...
  return (
    <header>
      <div className="overflow-x-hidden bg-gray-800">
        {/* navigation */}
        <div className="relative flex max-w-screen-xl flex-col overflow-hidden p-4 text-gray-200 md:mx-auto md:flex-row md:items-center">
          <Navigation />
        </div>
        {/* hero section */}
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              <h1 className="mt-5 text-3xl font-light leading-snug text-white sm:text-5xl sm:leading-snug lg:text-6xl lg:leading-snug">
                Satisfy <br className="sm:hidden" />
                Cravings Instantly
                <span className="relative inline-flex justify-center whitespace-nowrap font-bold">
                  SwiftShop Foods
                </span>
              </h1>
              <p className="mx-auto max-w-md text-base leading-7 text-gray-300">
                Order Delectable Delights on SwiftShop for a culinary Experience
                at Your Fingertips.
              </p>
              ...
              <form className="mt-10">
                <div className="group bg-white/20 border-white/50 focus-within:ring-1 focus-within:ring-white/50 relative border p-1 backdrop-blur-md sm:flex-row">
                  ...
                  />
                  <div className="border-white/50 flex sm:absolute sm:inset-y-0 sm:right-0 sm:h-full sm:border-1">
                    <button
                      type="submit"
            ...
            <div className="my-16 flex flex-col items-center justify-center divide-y divide-gray-500 border border-gray-600 bg-gray-700 shadow-lg sm:flex-row sm:divide-x sm:divide-y-0 md:mt-32">
