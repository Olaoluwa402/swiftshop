...
import { logoutAction } from "../../redux/features/slices/authLoginSlice";
...
const SideBar = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="bg-slate-800 mt-5 py-4 pl-10 md:mt-10"
          onClick={() => navigate("/")}
        >
          <span className="">
        ...
        <ul className="mt-8 space-y-3 md:mt-20">
          <li className="relative" onClick={() => navigate("/dashboard")}>
        ...
        <div className="my-6 mt-auto ml-10 flex cursor-pointer">
          ...
          <div className="ml-3">
            ...
            <button
              ...
              className="w-[75px]  rounded-md p-2 cursor-pointer text-sm text-white bg-red-950 hover:bg-red-500"
            >
              logout
            </button>
          </div>
