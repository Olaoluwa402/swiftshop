...
const ProductDetail = () => {
  ...
  useEffect(() => {
    if (!generalCtx.meal || (generalCtx.meal && generalCtx.meal.id != id)) {
      generalCtx.getMeal(id);
    }
  }, [id]);
              ...
              <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                ...
                <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                  ...
                  <button
                    ...
                    onClick={() =>
                      cartCtx.addItem({
                        id: generalCtx.meal.id,
                        name: generalCtx.meal.name,
                        price: generalCtx.meal.price,
                        image: generalCtx.meal.image,
                        amount: 1,
                      })
                    }
                    type="button"
                  ...
                  >
                    ...
                    {inCart ? (
                      <span className="text-green-800">In cart</span>
                    ) : (
                      "Add to cart"
                    )}
                  </button>
